...
foreach ($lineas as $linea) {
    ...
    if ($i != 0) {
        ...
        mysqli_stmt_bind_param($stmt, 'issssdddsi', $id, $rack, $location, $ax, $description, $um, $price, $stock, $physics, $estado);
